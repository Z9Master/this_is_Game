...
{
    public class web_block_data_managerment
    {
        ...
        public web_block_data_managerment()
        {
            file_path = Settings.Default.FilePathWeb;
            get_data_from_file();
        }
        ...
        void save_path()
        {
            Settings.Default.FilePathWeb = file_path;
